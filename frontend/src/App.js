...
function App() {
  const {abstraxionAccount, isConnected, login, logout} = (0,
  abstraxion_react_native_1.useAbstraxion)();
  ...
  return (
    <react_native_1.SafeAreaView style={styles.container}>
      ...
      <react_native_1.View style={styles.buttonContainer}>
        {isConnected ? (
          <react_native_1.Button title="Logout" onPress={logout} />
        ) : (
      ...
      {isConnected && abstraxionAccount ? (
        <react_native_1.View>
          <react_native_1.Text>
            Starknet Account: {abstraxionAccount.address}
          </react_native_1.Text>
          <react_native_1.Button
          ...
          <Subscriptions_1.Subscriptions
            abstraxionAccount={abstraxionAccount}
          />
        </react_native_1.View>
      ) : (
        <react_native_1.Text>
